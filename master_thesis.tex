...
\large{
Ուսանող՝ \hspace{0.3cm}  \hrulefill \hspace{0.3cm}  Մինասյան Գ.Մ.   \hspace{4.5cm}} \\

\large{Գիտական ղեկավար՝ ֆիզ.-մաթ. գիտությունների թեկնածու} \\

\large{\hspace{7cm} \hrulefill  \hspace{0.3cm}  Դանոյան Հ.Է.} \\
...
\large{\textbf{«Թույլատրել պաշտպանության»}} \\

\large{Ամբիոնի վարիչ՝  ֆիզ.-մաթ. գիտությունների դոկտոր, պրոֆեսոր} \\

\large{\hspace{7cm} \hrulefill  \hspace{0.3cm}  Հակոբյան Յու.Ռ.} \\

\large{31 մայիսի 2019 թ.}}
...
\label{bs_inequality}
\begin{align}
\frac{1}{N}\sum_{i=1}^N L(T_i, f, W_{T_i}) \leq  \frac{m_{max}}{(n+1) \rho_{min}}  L(T, f, W) \text{ } \forall f \in \mathcal{F}, W \in \mathcal{V} 
\end{align}
\end{lemma}
\begin{proof}[Ապացույց]
...
Համանման ձևով $\forall i \in [N]$ համար՝
...
Ակնհայտ է $\forall i \in [N], \forall f \in \mathcal{F}, \forall W \in \mathcal{V}$  և $\forall c \in T_i$ համար տեղի ունի՝ 
